namespace Bursify.Data.Migrations
{
    ...
    public partial class initial : DbMigration
    {
        ...
        public override void Down()
        {
                ...
                c => new
                    {
                        ...
                        PasswordHashed = c.String(nullable: false, maxLength: 200),
            ...
            DropForeignKey("dbo.SponsorshipStudent", "Student_BursifyUserId", "dbo.Student");
            DropForeignKey("dbo.SponsorshipStudent", "Sponsorship_SponsorshipId", "dbo.Sponsorship");
            ...
            DropIndex("dbo.SponsorshipStudent", new[] { "Student_BursifyUserId" });
            DropIndex("dbo.SponsorshipStudent", new[] { "Sponsorship_SponsorshipId" });
            ...
            DropTable("dbo.SponsorshipStudent");
