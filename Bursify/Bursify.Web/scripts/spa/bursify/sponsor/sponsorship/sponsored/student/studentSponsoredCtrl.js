(function (app) {
    ...
    app.controller('studentSponsoredCtrl', studentSponsoredCtrl);

    studentSponsoredCtrl.$inject = ['$scope', '$rootScope', 'apiService', 'notificationService', 'membershipService', '$timeout', 'fileUploadService', '$routeParams', '$mdDialog', '$mdMedia'];


    function studentSponsoredCtrl($scope, $rootScope, apiService, notificationService, membershipService, $timeout, fileUploadService, $routeParams, $mdDialog, $mdMedia) {
